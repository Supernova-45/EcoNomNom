...
class _UploadImageWidgetState extends State<UploadImageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'UploadImage'});
            ...
            children: [
              Opacity(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/background_for_app.jpg',
                    ...
                    children: [
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              ...
                                              'https://endlessicons.com/wp-content/uploads/2012/11/camera-icon.png',
                                            ),
                                            width: 95.0,
                                            height: 200.0,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'UPLOAD_IMAGE_PAGE_SUBMIT_BTN_ON_TAP');
